...
public class projectManager extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().trim().equals("") || jTextField2.getText().trim().equals("")){
            JOptionPane.showMessageDialog(this, "Please enter both the project and manager IDs");
        }
        else
            try {
            dbConnector.projManager( Integer.parseInt(jTextField1.getText().trim()), Integer.parseInt(jTextField2.getText().trim()));
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Please enter numeric IDs!");
        }
