...
//            }
    ...
    public static void modifyEmployee(String name, String id, String newName, String newSalary, String newBirthDate, String newEmail, String newEmploymentDate, String newDepartmentName, String newAddress, String newRole, String phone) throws Exception {
        int eid = 0;
        try{
            if (!phone.equals("")){
        ...
        System.out.println("Query entry is successful");
            ...
            if (newRole.equals("---") && phone.equals("")){
                throw new Exception("Error Modifying Employee");
            }
            else{
              JOptionPane.showMessageDialog(null,"Error Updating Some Values");   
            }
        ...
        if (!newRole.equals("---")) {
            ...
            try {
                ...
                for (int i = 0; i < rsString.size(); i++) {
                    String tempQuery = "replace into role_emp values(";
...
//            }
    ...
    public static void modifyRequest(String id, String newName, String priority, String department, boolean arrived, String supName, String price, String date) throws Exception {
        ...
        try {
            ...
            throw new Exception("Error! please enter valid data");
        }
    }
